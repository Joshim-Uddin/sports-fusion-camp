...
const Navbar = () => {
  ...
  const { user, logout,night, setNight } = useContext(AuthContext);
  const role = useUsers();
    ...
    <>
      ...
      {!role && user? (
        ...
        <div className="relative me-2">
          <div className="badge badge-secondary absolute md:bottom-5  md:left-2 bottom-2 left-4">
            {selected?.length}
          </div>
  ...
  <input type="checkbox" onClick={()=>setNight(!night)}/>
