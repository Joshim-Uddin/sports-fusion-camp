...
const CountDown = () => {
  const renderer = ({ days, hours, minutes, seconds }) => {
    return (
      <div className="grid md:grid-cols-4 grid-cols-2 justify-center items-center md:gap-5 gap-3">
        <Tilt>
          <div className="flex flex-col items-center bg-[#021a30] py-4 px-16 rounded-md ">
  ...
  return (
    <div className="count text-white py-10 md:px-24 px-4 flex flex-col gap-5 md:flex-row items-center justify-between">
