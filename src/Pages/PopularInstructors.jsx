...
const PopularInstructors = () => {
  ...
  return (
    ...
    data-aos-once="false"
     className="w-11/12 md:w-10/12 mx-auto my-3">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-4 my-4 pt-10">{
        instructors.map((item, index)=><div key={index} className="mb-5 p-4 hover:-translate-y-5 hover:transition-transform hover:shadow-lg rounded-lg">
